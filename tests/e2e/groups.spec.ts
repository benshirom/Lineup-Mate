...
test.describe.serial('group collaboration flows', () => {
  ...
  test('Groups page lets an owner create a group and open it', async ({ page }) => {
    ...
    await expect(
      page.getByTestId('create-group-submit'),
      'Create Group should be enabled after a festival is available and a group name is filled.'
  ...
  test('owner creates a group, member joins, and group schedule shows timeline', async ({ page }) => {
