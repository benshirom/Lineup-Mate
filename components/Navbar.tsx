...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      style={{ background: c.surf, borderBottom: `1px solid ${c.brd}`, color: c.txt }}
    ...
    >
      ...
      <div className="flex items-center gap-3">
        {user ? (
          <>
            <span
              className="hidden sm:inline text-xs font-black px-3 py-1 rounded-full"
            ...
            <button
              ...
              className="rounded-full px-3 py-1 text-xs font-black hover:opacity-80"
